...
namespace NSI.BusinessLogic.Utilities
{
    ...
    {
        public static string GetPassportHtmlString(Document document, User user)
        {
           return GetHtmlString(document, user);
        }
        
        public static string GetVisaHtmlString(Document document, User user)
        {
           return GetHtmlString(document, user);
        }

        private static string GetHtmlString(Document document, User user)
        {
           return @"
                     <div>
